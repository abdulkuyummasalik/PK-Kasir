...
{
    public $kode, $total, $kembalian, $totalSemua;
    ...
    {
        if ($this->bayar > 0) {
            $this->kembalian = $this->bayar - $this->totalSemua;
        }
    }
    ...
    {
        $this->transaksiAktif->total = $this->totalSemua;
    ...
    public function render()
    {
        ...
        if ($this->transaksiAktif) {
            ...
            $this->totalSemua = $semuaProduk->sum(function ($detail) {
